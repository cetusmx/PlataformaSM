...
import { BiXCircle, BiUpload, BiRefresh, BiCheckDouble, BiTrash } from "react-icons/bi";
import { show_alerta } from "../functions";
import Axios from "axios";
import { Spinner } from "react-bootstrap";

const FacturaXMLEditable = ({ storageKey = "factura_progress" }) => {
                ...
                <table className="tabla-factura">
                    <thead>
                        <tr>
                            ...
                            <th style={{ width: "25%" }}>Clave Prov. / Descripción</th>
                            <th style={{ width: "15%" }}>Clave</th>
                            <th style={{ width: "9%", textAlign: "right" }}>V. Unitario</th>
                            <th style={{ width: "9%", textAlign: "right" }}>Importe</th>
                            <th style={{ width: "10%", textAlign: "right" }}>Desc. (%)</th>
                            <th style={{ width: "9%", textAlign: "right" }}>Monto Desc.</th>
                            ...
                            return (
                                <tr key={item.id}>
                                    ...
                                    <td style={{ textAlign: "center" }}>
                                        <button className="btn btn-outline-danger btn-sm" onClick={() => eliminarPartida(item.id)} title="Eliminar fila">
                                            <BiTrash />
                                        </button>
                                    </td>
                                </tr>
...
export default FacturaXMLEditable;
